  ...
  $(function() {
    ...
    calculate_menu();
        ...
        $('.open-left-sidebar').click(function(){
        	console.log('open-left-sidebar clicked...');
...
function activeTab(tab){
	 if(tab === 'activate-tab-1'){
	  $('#tab-2').slideUp(250); $('#tab-1').slideDown(250);
	 }else{
	  $('#tab-1').slideUp(250); $('#tab-2').slideDown(250);
	 }
	    $('.home-tabs button').removeClass('active-home-tab');
	    $('.'+tab).addClass('active-home-tab');
	    return false;
	}